...
### 📍 Etapa 2: Conexão com WhatsApp & n8n (Homelab / Raspberry Pi) [CONCLUÍDA]
...
- [x] **2.3** Acessar o n8n (`http://localhost:5678`), criar o usuário admin e importar os fluxos da pasta `workflows/`.
...
- [x] **4.5** Importar e ativar o **Master Orchestrator** no n8n do Raspberry Pi (`http://192.168.1.99:5678`).
